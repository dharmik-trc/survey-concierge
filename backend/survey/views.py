...
from .models import PartialSurveyResponse, Question, Survey
...
def question_detail(request, survey_id, question_id):
    ...
    question = get_object_or_404(
        Question, id=question_id, survey_id=survey_id, survey__is_active=True
    )
...
def submit_survey_response(request, survey_id):
    ...
    try:
        ...
        for question_id, answer in responses.items():
            ...
            if question_id_int in comment_responses:
                ...
                if comment_text and comment_text.strip():
                    ...
                    combined_answer = {"answer": answer, "comment": comment_text}
        ...
        if serializer.is_valid():
            ...
            if session_id:
                ...
                PartialSurveyResponse.objects.filter(
                    survey=survey, ip_address=ip_address, session_id=session_id, is_completed=False
        ...
        return Response(
            {"error": "Failed to submit survey response", "details": str(e)},
