...
from .exports import export_survey_responses, export_analytics, export_segmented_analytics, export_filtered_analytics, preview_segmented_analytics, preview_filtered_analytics
...
urlpatterns = [
    ...
    path('surveys/<uuid:survey_id>/analytics/export-segmented/', export_segmented_analytics, name='export_segmented_analytics'),
    path('surveys/<uuid:survey_id>/analytics/preview-segmented/', preview_segmented_analytics, name='preview_segmented_analytics'),
    path('surveys/<uuid:survey_id>/analytics/export-filtered/', export_filtered_analytics, name='export_filtered_analytics'),
    path('surveys/<uuid:survey_id>/analytics/preview-filtered/', preview_filtered_analytics, name='preview_filtered_analytics'),
] 