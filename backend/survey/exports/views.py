...
def export_filtered_analytics(request, survey_id):
    ...
    try:
        ...
        print(f"DEBUG export_filtered_analytics: total sessions before filtering: {len(sessions)}")
        print(f"DEBUG export_filtered_analytics: filtered_sessions count: {len(filtered_sessions)}")
        print(f"DEBUG export_filtered_analytics: exclude_open_text: {exclude_open_text}")
...
def preview_filtered_analytics(request, survey_id):
    ...
    try:
        ...
        total_count = len(sessions)
        print(f"DEBUG preview_filtered_analytics: total sessions before filtering: {total_count}")
        print(f"DEBUG preview_filtered_analytics: filtered_sessions count: {filtered_count}")
        print(f"DEBUG preview_filtered_analytics: exclude_open_text: {exclude_open_text}")
        ...
        if exclude_open_text:
            ...
            filtered_questions_count = len(questions_to_include)
            print(f"Preview: exclude_open_text={exclude_open_text}, Excluding {open_text_excluded_count} open text questions: {original_count} -> {filtered_questions_count} questions")
            # List excluded questions for debugging
            if open_text_questions:
