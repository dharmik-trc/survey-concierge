    ...
    for dimension in dimensions:
        ...
        if dim_type == 'numeric_range':
            ...
            for session_id, session_data in sessions.items():
                ...
                if question.primary_type == 'form' and question.secondary_type == 'multiple_choices':
                    answer_values = _get_location_answer(answer)
                elif question.primary_type == 'form' and question.secondary_type in ['radio', 'dropdown']:
