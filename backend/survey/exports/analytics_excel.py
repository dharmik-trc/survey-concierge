...
def create_analytics_excel(analytics: Dict, questions: List, survey_title: str) -> openpyxl.Workbook:
    ...
    for question in questions:
        ...
        if question_type == 'choice':
            ...
            row_num = write_form_fields_numeric_analytics(ws, analytics_data, row_num, styles, border)
...
def write_choice_analytics(ws, analytics_data: Dict, start_row: int, styles: Dict, border: Border) -> int:
...
def write_grid_analytics(ws, analytics_data: Dict, start_row: int, styles: Dict, border: Border) -> int:
...
def write_comments_table(ws, comments: List[Dict], start_row: int, styles: Dict, border: Border) -> int:
...
def write_numeric_analytics(ws, analytics_data: Dict, start_row: int, styles: Dict, border: Border) -> int:
...
def write_form_fields_numeric_analytics(ws, analytics_data: Dict, start_row: int, styles: Dict, border: Border) -> int:
